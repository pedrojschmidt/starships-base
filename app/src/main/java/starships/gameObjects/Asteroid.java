...
public class Asteroid extends GameObject {
    ...
    public Asteroid(String id, ObjectStyle style, ObjectSize size, Vector position, Vector direction, double speed, double rotationDegrees, double damage, double health, boolean isVisible, int pointsWhenDestroyed) {
        super(id, ObjectType.ASTEROID, style, ObjectShape.CIRCULAR, size, position, direction, speed, rotationDegrees, damage, health, isVisible, health);
    ...
    public Asteroid setPosition(Vector position) {
        return new Asteroid(getId(), getStyle(), getSize(), position, getDirection(), getSpeed(), getRotationDegrees(), getDamage(), getInitialHealth(), isVisible(), pointsWhenDestroyed);
    }

    public Asteroid setDirection(Vector direction) {
        return new Asteroid(getId(), getStyle(), getSize(), getPosition(), direction, getSpeed(), getRotationDegrees(), getDamage(), getInitialHealth(), isVisible(), pointsWhenDestroyed);
    }

    public Asteroid setSpeed(double speed) {
        return new Asteroid(getId(), getStyle(), getSize(), getPosition(), getDirection(), speed, getRotationDegrees(), getDamage(), getInitialHealth(), isVisible(), pointsWhenDestroyed);
    }

    public Asteroid setRotationDegrees(double rotationDegrees) {
        return new Asteroid(getId(), getStyle(), getSize(), getPosition(), getDirection(), getSpeed(), rotationDegrees, getDamage(), getInitialHealth(), isVisible(), pointsWhenDestroyed);
    }

    public Asteroid setVisible(boolean visible) {
        return new Asteroid(getId(), getStyle(), getSize(), getPosition(), getDirection(), getSpeed(), getRotationDegrees(), getDamage(), getInitialHealth(), visible, pointsWhenDestroyed);
    }
